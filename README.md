...
The final license should be selected by the authors before public release. A placeholder license note is included in `LICENSE.md`.

## Citation

Use `CITATION.cff` after the manuscript DOI has been assigned. Until then, cite the manuscript as submitted or in preparation.
