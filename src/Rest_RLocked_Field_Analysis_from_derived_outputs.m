...
% Repository-oriented defaults. This script reads derived waveform and metric exports from the repository data folder and writes recomputed outputs under results/recomputed.

repoRoot = string(fileparts(fileparts(mfilename('fullpath'))));
cfg.projectRootOverride = repoRoot;
cfg.baseDirOverride = string(fullfile(repoRoot, 'Data'));
cfg.analysisRootOverride = string(fullfile(repoRoot, 'results', 'recomputed'));
cfg.metricRootOverride = string(fullfile(repoRoot, 'data', 'derived_subject_level'));
cfg.statsRootOverride = string(fullfile(repoRoot, 'results', 'recomputed'));
cfg.inputDirOverride = string(fullfile(repoRoot, 'data', 'derived_subject_level'));
